 ...
 */
const HeaderSessionSearch: React.FC<HeaderSessionSearchProps> = ({ value, onChange, isDarkMode }) => {
  ...
  return (
    <div
      className={`flex w-full min-w-0 max-w-2xl items-center gap-2 rounded-xl border px-3 py-2 transition-colors ${shell}`}
    >
      <MagnifyingGlassIcon
