  ...
  return (
    <div className={`animate-fade-in min-h-full w-full ${pageBg}`}>
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 md:py-10 lg:px-8 lg:py-12">
        ...
        <section className="mt-12" aria-label="Recursos complementares" data-testid="secondary-features-notice">
          <div className={`rounded-xl border px-6 py-8 text-center ${isDarkMode ? 'border-slate-700/60 bg-slate-900/40' : 'border-slate-200 bg-slate-50/60'}`}>
            <p className={`text-sm font-medium ${textPrimary}`}>Disponível em breve.</p>
            <p className={`mt-1 text-sm ${textSecondary}`}>Estamos priorizando a estabilização e a qualidade dos dossiês.</p>
          </div>
        </section>
