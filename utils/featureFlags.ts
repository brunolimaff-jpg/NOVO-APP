export type FeatureFlagName = 'deepDive' | 'warRoom' | 'newExportFlow' | 'radarV2' | 'inlineLoading' | 'dossierCard' | 'heavyDefer';
...
export const FEATURE_FLAGS: Record<FeatureFlagName, FeatureFlagConfig> = {
  ...
  heavyDefer: { default: false, removeBy: 'BUG-8 v6 follow-up — SectionalBotMessage DeferredMessageSkeleton preso', envOverride: 'VITE_FF_HEAVY_DEFER' },
};
