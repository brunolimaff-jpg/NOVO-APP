export const PROMPT_RAIO_X_OPERACIONAL_ATAQUE_V2 = `
...
<evidence_pack>
O Evidence Pack abaixo foi coletado pelo pipeline de busca ANTES desta análise.
NÃO busque. NÃO invente URLs. Use APENAS as URLs listadas abaixo.
Se um campo não tiver evidência, declare "LACUNA: ..." — não infira.
...
`;
export const PROMPT_TECH_STACK_GOD_MODE_ATAQUE_V2 = `
...
`;
export const PROMPT_RISCOS_COMPLIANCE_GOD_MODE_V2 = `
...
`;
export const PROMPT_RADAR_EXPANSAO_GOD_MODE_V2 = `
...
`;
export const PROMPT_RH_SINDICATOS_GOD_MODE_V2 = `
...
`;
export const PROMPT_MAPEAMENTO_DECISORES_GOD_MODE_V2 = `
...
`;
export const PROMPT_ORCAMENTO_JANELA_GOD_MODE_V2 = `
...
`;
export const PROMPT_CAMINHO_DE_VENDA_V2 = `
...
`;
export const ALL_SPECIALIST_PROMPTS_V2 = [
  ...
  PROMPT_RH_SINDICATOS_GOD_MODE_V2,
  PROMPT_MAPEAMENTO_DECISORES_GOD_MODE_V2,
  PROMPT_ORCAMENTO_JANELA_GOD_MODE_V2,
