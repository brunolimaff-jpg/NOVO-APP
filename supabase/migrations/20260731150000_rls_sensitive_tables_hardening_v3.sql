-- =====================================================================
-- RLS/Auth hardening for sensitive operator-owned tables (v3).
-- Rebuilt on current main; idempotent and fail-closed.
-- =====================================================================
-- Diferenças vs tentativa anterior: migration funcional, idempotente e fail-closed.
