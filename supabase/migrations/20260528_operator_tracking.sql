...
-- Nao ha politicas RLS restritivas porque o operador e anonimo
-- (sem auth Supabase). O acesso e controlado via API Key anon/public.
-- Se necessario no futuro, adicionar politicas baseadas em operator_id.
