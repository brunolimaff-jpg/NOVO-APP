...
-- Closes legacy policies that trusted client-supplied operator_id values.
--
-- Rollback strategy: ship a corrective migration that restores the prior
-- policy names only after an explicit product/security decision.
