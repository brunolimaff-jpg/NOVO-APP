...
| OI-032 | low | open | `HANDOFF_AI.md` antigo continha contexto de auth desatualizado | Pode confundir outras IAs | Manter o handoff sincronizado com o estado real do app |
