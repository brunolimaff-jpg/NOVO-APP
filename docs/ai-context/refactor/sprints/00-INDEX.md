...
### Branches
- Cada sprint usa branch `refactor/sprint-N` derivada de `main`.
- PRs internos da sprint usam sufixos: `refactor/sprint-9-onda-1-leak`, `refactor/sprint-9-onda-2-flags`, etc.
