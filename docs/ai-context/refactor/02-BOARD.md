...
| Campo | Valor |
|---|---|
| Source of truth commit | `origin/main` -> `ef30b5d3b932a9358b25ad5ec284dbb35f992109` |
| Working branch | `main` |
...
- Proximo sprint do roadmap: Sprint 3 (extrair chat de `App.tsx` sem regressao funcional)

## Next Up

1. Iniciar Sprint 3 com extracao gradual do fluxo de chat para `features/chat/*`
2. Manter `App.tsx` como fachada de compatibilidade durante a extracao
3. Validar cada corte com `test`, `typecheck`, `build` e checkpoint manual em preview Vercel
...
- Reexecutar checklist manual completo no primeiro corte de Sprint 3 para confirmar paridade visual/funcional
...
| 3 | Extrair chat do App | active | `features/chat/` ativo; `App.tsx` reduzido | `start-of-sprint-3` | `App.tsx`, `features/chat/*` |
