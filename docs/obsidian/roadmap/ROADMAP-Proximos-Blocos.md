...
- Concluir Sprint 11 Onda 1A: saneamento dos planos em aberto.
- Seguir para Sprint 11 Onda 1B: `LoadingSmart` com fachada preservada.
- Seguir para Sprint 11 Onda 1C: `WarRoom` com props públicas preservadas.
