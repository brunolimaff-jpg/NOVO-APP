/**
 * Budgets de tempo do pipeline LLM (BRU-155).
 *
 ...
 *
 * Regressão observada em run a970a808: steps internos de 60s/90s abortavam
 * chamadas válidas de investigação (Teia Identity e Riscos & Compliance).
 */
...
/** Step de módulo obrigatório (Teia Identity): cobre o proxy + headroom. */
