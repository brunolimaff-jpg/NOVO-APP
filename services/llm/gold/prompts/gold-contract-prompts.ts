...
export function buildComposePrompt(input: ComposeInput): string {
  return [
    ...
    'Linguagem executiva. 900-1500 palavras (NUNCA abaixo de 900 — o contrato rejeita abaixo; se ficar curto, aprofunde as seções 4-8). 0-3 Mermaid (use até 3 quando houver suporte: Mapa do Caos + Teia + um terceiro quando agregar, ex.: cadeia de valor ou linhas de negócio). Máx 3 sinais.',
