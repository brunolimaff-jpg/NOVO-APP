// Public façade preserved for App.tsx, ChatInterface.tsx, LoadingSmart.tsx and tests.
...
export {
  ...
  generateLoadingCuriosities,
} from './gemini/auxiliary';
export {
  generateDossierModule,
  getIsolatedBenchmark,
  sendMessageToGemini,
} from './gemini/investigation-orchestration';
export {
  isMegaPromptRequest,
} from './gemini/runtime';
