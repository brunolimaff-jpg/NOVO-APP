...
12. **Checkpoint de branch**: A cada 5 commits, rodar `git log <baseline>..HEAD --oneline` usando a baseline do plano (ex: `origin/stabilize/from-production-fe6c6f9`), e verificar se já não é hora de abrir PR.
