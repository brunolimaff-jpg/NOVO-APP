...
const App: React.FC = () => {
  ...
  const hasOperatorNameForMigration = operatorName.trim().length > 0;
  const { showMigrationNotice, dismissMigrationNotice } = useMigrationNotice(operatorId, hasOperatorNameForMigration);
