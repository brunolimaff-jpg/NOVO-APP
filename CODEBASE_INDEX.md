...
- `geminiService.ts` — parsePortaFeeds, cleanPortaFeedMarkers, parseMarkers, isMegaPromptRequest, generateLoadingCuriosities, generateContinuityQuestion, sendMessageToGemini, GeminiRequestOptions +2
...
- `.agents/skills/test-strategy/evals.json`
