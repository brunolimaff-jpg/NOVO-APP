...
| Item                                     | Status                                        | Link                                                          |
| ---------------------------------------- | --------------------------------------------- | ------------------------------------------------------------- |
| PR #313 `fix/remove-web-search-fallback` | **Mergeable** (CI pendente)                   | PR #313                                                       |
| PR #314 `feat/dossier-lifecycle`         | 10 commits, 15 findings code review pendentes | PR #314                                                       |
...
| Data       | Marco                                                                                                     | Link                                                                        |
| ---------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| 2026-05-29 | **PR #314 aberta** — feat/dossier-lifecycle (10 commits)                                                  | PR #314, vault nova sessao                                                  |
| 2026-05-29 | **PR #313 merge conflict resolvido** — fix/remove-web-search-fallback agora MERGEABLE                     | PR #313, vault nova sessao                                                  |
| 2026-05-29 | **Code review max-effort** — feat/dossier-lifecycle: 1047 linhas, 11 arquivos, 9 angulos, 65->15 findings | HANDOFF, vault `2026-05-29T17-30-00-code-review-dossier-lifecycle-pr313.md` |
| 2026-05-29 | **PR #313 aberta** — fix/remove-web-search-fallback: remove DuckDuckGo fallback, review resolvido, DIRTY  | PR #313                                                                     |
