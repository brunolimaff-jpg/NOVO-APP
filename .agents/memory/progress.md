...
| PR #327 — Socio-search decomposition        | **ABERTA**, branch `refactor/socio-search-decompose`, com rastreio de painel branco + gates E2E longos adicionados | PR #327, HANDOFF_AI.md |
